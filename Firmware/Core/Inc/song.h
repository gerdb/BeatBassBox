...
typedef enum
{
	SONG_J_REPEAT, SONG_J_REPEAT_REL, SONG_J_FINE, SONG_J_VOLTA1, SONG_J_JUMP, SONG_END
} SONG_JumpType_e;

typedef enum
{
	EXTRA_JUMP, EXTRA_TEMPO, EXTRA_RES2, EXTRA_RES3, EXTRA_RES4, EXTRA_RES5, EXTRA_RES6, EXTRA_RES7
} SONG_ExtraType_e;
